...
export default function StudyCard({ study }: StudyCardProps) {
  ...
  return (
    <Link href="/study">
      <Card className="flex w-44 transform cursor-pointer flex-col items-center justify-center overflow-hidden px-2 py-4 transition-opacity hover:opacity-90 sm:w-64 sm:px-4 sm:py-8">
